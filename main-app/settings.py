...
SECRET_KEY = "django-insecure-*hjp(z-zusa_wgx0qn&^!n-!+#bqs1=#)j6^6&pjb!)^n4i$8@"
...
ROOT_URLCONF = "main-app.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [Path.joinpath(BASE_DIR, "projects/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "main-app.wsgi.application"
...
#        'NAME': 'django_projects',  # Replace with your database name
#        'USER': 'springstudent',  # Replace with your MySQL username
#        'PASSWORD': 'Bamn1968',  # Replace with your MySQL password
...
# Static files will be built here
STATIC_ROOT = "build/"
